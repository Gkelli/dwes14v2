...
public class MuestraVariablesServidor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {         
            ...
            out.println("Parametros de inicio añadidos: " + contexto.getInitParameter("numero") + " y: " + contexto.getInitParameter("curso"));
            
            out.println("<br/>Incluye en el servlet el código necesario para recorrer todos los parámetros del contexto y mostrarlos con el formato *nombre: valor* :<br/>");
            ...
            out.println("<br/>Añade dos parámetros de inicio sólo para este servlet en el descriptor."
            		+ "mIncluye en el servlet el código necesario para mostrarlos:<br/>");
            
            Enumeration<String> parametros_servlet = this.getInitParameterNames();
            while (parametros_servlet.hasMoreElements()) {
				String actual = parametros_servlet.nextElement();
				out.println( actual + ":" + contexto.getInitParameter(actual) + "<br/>");				
			}
